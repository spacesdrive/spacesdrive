...
<picture>
  ...
  <img src="./assets/profile-card-light.svg" alt="Ujjwal Kumar Rai (@spacesdrive): ASCII portrait with system-info style profile. GitHub stats: 13 public repos, 207 stars, 28 forks, 868 commits, 15 pull requests, 1 issue, 3 followers, 1,127 contributions in the past year, 390,599 net lines of code." width="100%">
</picture>
<!-- GITHUB_STATS_END -->
