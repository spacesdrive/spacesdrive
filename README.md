...
<picture>
  ...
  <img src="./assets/profile-card-light.svg" alt="Ujjwal Kumar Rai (@spacesdrive): ASCII portrait with system-info style profile. GitHub stats: 13 public repos, 206 stars, 28 forks, 867 commits, 15 pull requests, 1 issue, 2 followers, 1,126 contributions in the past year, 390,653 net lines of code." width="100%">
</picture>
<!-- GITHUB_STATS_END -->
